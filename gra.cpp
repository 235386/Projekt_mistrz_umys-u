...
void Ramka(int xp,int yp,int xk,int yk)
{
  ...
  pozycja_konsoli(xp,yp); putch(char(174));
  pozycja_konsoli(xp,yk); putch(char(174));
  pozycja_konsoli(xk,yp); putch(char(174));
  pozycja_konsoli(xk,yk); putch(char(174));
  for(i = xp + 1; i <= xk - 1; i++)
  {
    pozycja_konsoli(i,yp); putch(char(174));
    pozycja_konsoli(i,yk); putch(char(174));
  };
  for(i = yp + 1; i <= yk - 1; i++)
  {
    pozycja_konsoli(xp,i); putch(char(0xFF));
    pozycja_konsoli(xk,i); putch(char(0xFF));
  };
}
